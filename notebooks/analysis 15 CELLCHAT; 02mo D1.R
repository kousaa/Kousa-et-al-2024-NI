...
adata_object <- adata$read_h5ad("../output/cellchat_io/cd45neg_0147_SLTBI_vdb_02mo_d1_NEW.h5ad")
...
saveRDS(cellchat, file = "../output/cellchat_io/cd45neg_0147_SLTBI_vdb_02mo_D1_NEW_cellchatDB.rds")
