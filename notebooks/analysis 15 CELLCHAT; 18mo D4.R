...
adata_object <- adata$read_h5ad("../output/cellchat_io/cd45neg_0147_SLTBI_vdb_18mo_d4_NEW.h5ad")
...
saveRDS(cellchat, file = "../output/cellchat_io/cd45neg_0147_SLTBI_vdb_18mo_D4_NEW_cellchatDB.rds")
