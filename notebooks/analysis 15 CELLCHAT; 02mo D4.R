...
adata_object <- adata$read_h5ad("../output/metadata/cellchat_io/cd45neg_0147_SLTBI_vdb_02mo_d4_NEW-light.h5ad")
...
saveRDS(cellchat, file = "../output/cellchat_io/cd45neg_0147_SLTBI_vdb_02mo_D4_NEW_cellchatDB.rds")
